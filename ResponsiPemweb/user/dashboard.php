...
<body>
    ...
    <section class="main">
      ...
      <section class="main-course">
        <div class="course-box1">
          ...
          <!-- </br>
          <p>Silahkan Cek Dan Edit Profile Pada Halaman Profile : </p>
          </br>
          <button class = "searchBut" id="go-profile" >
  ...
  <script>
    ...
    document.getElementById("go-profile").addEventListener("click", function(event) {
      event.preventDefault();
      window.location.href = "dashboard_edit_profile.php";
    });
  </script>
