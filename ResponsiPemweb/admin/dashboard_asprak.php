...
function deleteDataByNim($conn, $nim) {
    $delete_query = "CALL hapus_asisten_praktikum(?)"; //Penerapan Stored Procedure (Bab1)
...
if (isset($_POST['delete_nim'])) { // Ubah menjadi POST
    $nim_to_delete = $_POST['delete_nim'];
    deleteDataByNim($conn, $nim_to_delete);
}
?>
    ...
    <section class="main">
        ...
        <section class="main-course">
            <div class="course-box1">
                <a href="#" class="inputAsprak" onclick="tambahAsprak(); return false;">Tambah Asisten Praktikum</a>
...
<script>
    function tambahAsprak() {
        var addUrl = 'inputAsprak.php';
        loadContent(addUrl, true);
    }
</script>
<script>
    function editAsprak(nim) {
        var editUrl = 'editAsprak.php?nim=' + nim;
